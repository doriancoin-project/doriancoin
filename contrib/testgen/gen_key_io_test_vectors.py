...
bech32_templates = [
  ...
  ('dsv',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('dsv',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('dsv',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('dsv',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tdsv',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ...
  ('rdsv', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tdsv',   17, 32, Encoding.BECH32M, False, False, False),
  ('rdsv',  3,  1, Encoding.BECH32M, False, False, False),
  ('dsv',   15, 41, Encoding.BECH32M, False, False, False),
  ('tdsv',    0, 16, Encoding.BECH32,  False, False, False),
  ('rdsv',  0, 32, Encoding.BECH32,  True,  False, False),
  ('dsv',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tdsv',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rdsv',  0, 20, Encoding.BECH32,  False, False, True),
  ('dsv',    0, 20, Encoding.BECH32M, False, False, False),
  ('tdsv',    0, 32, Encoding.BECH32M, False, False, False),
  ('rdsv',  0, 20, Encoding.BECH32M, False, False, False),
  ('dsv',    1, 32, Encoding.BECH32,  False, False, False),
  ('tdsv',    2, 16, Encoding.BECH32,  False, False, False),
  ('rdsv', 16, 20, Encoding.BECH32,  False, False, False),
]
