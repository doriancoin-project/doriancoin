...
bech32_templates = [
  ...
  ('dsv',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('dsv',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('dsv',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tdsv',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tdsv',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tdsv',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rdsv',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rdsv',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rdsv', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tdsv',  17, 32, False, False, False),
  ('rdsv',  3,  1, False, False, False),
  ('dsv',   15, 41, False, False, False),
  ('tdsv',  0, 16, False, False, False),
  ('rdsv',  0, 32, True,  False, False),
  ('dsv',   0, 16, True,  False, False),
  ('tdsv',  0, 32, False, True,  False),
  ('rdsv',  0, 20, False, False, True)
]
