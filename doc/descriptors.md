# Support for Output Descriptors in Doriancoin Core

Since Doriancoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `dsv1...` for mainnet or `tdsv1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Doriancoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Doriancoin Core wallets, a convenience function `combo` is
