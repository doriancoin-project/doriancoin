# Fuzzing Doriancoin Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Doriancoin Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
[`process_message`](https://github.com/doriancoin-project/doriancoin/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/doriancoin-project/doriancoin/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/doriancoin-project/doriancoin/tree/master/src/test/fuzz).
...
Every single pull request submitted against the Doriancoin Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Doriancoin Core more robust.
...
with certain assembly code from Doriancoin Core's code. See [developer notes on sanitizers](https://github.com/doriancoin-project/doriancoin/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Doriancoin Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Doriancoin Core using [`afl-fuzz`](https://github.com/google/afl):
