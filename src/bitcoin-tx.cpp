...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " doriancoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  doriancoin-tx [options] <hex-tx> [commands]  Update hex-encoded doriancoin transaction\n" +
            "or:     doriancoin-tx [options] -create [commands]   Create hex-encoded doriancoin transaction\n" +
            "\n";
