...
public:
    CMainParams() {
        ...
        consensus.CSVHeight = 1245000; // CSV activation (BIP68/112/113)
        consensus.SegwitHeight = 1245000; // SegWit activation (BIP141/143/147)
        ...
        consensus.MinBIP9WarningHeight = 1253064; // SegwitHeight + nMinerConfirmationWindow 
