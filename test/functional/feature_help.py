...
"""Verify that starting doriancoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start doriancoin with -h for help text")
        ...
        self.log.info("Start doriancoin with -version for version information")
        ...
        self.log.info("Start doriancoind with -fakearg to make sure it does not start")
