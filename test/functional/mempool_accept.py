...
class MempoolAcceptanceTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # MAX_STANDARD_TX_WEIGHT is 2180000 here (raised from Bitcoin's 400000 for
        # P2TR inscriptions), i.e. 545000 bytes. Overshoot it so the tx is oversized.
        num_scripts = 560000 // len(output_p2sh_burn.serialize())  # Use enough outputs to make the tx too large for our policy
