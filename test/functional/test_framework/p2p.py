...
MAGIC_BYTES = {
    "mainnet": b"\xd0\xc1\xb0\xd1",   # main
    "testnet4": b"\xd1\xd2\xc0\xd2",  # test
    "regtest": b"\xd2\xb0\xb1\xd3",   # regtest
}
...
class P2PConnection(asyncio.Protocol):
    ...
    def peer_connect(self, dstaddr, dstport, *, net, timeout_factor):
        ...
        logger.debug('Connecting to Doriancoin Node: %s:%d' % (self.dstaddr, self.dstport))
    ...
    def peer_accept_connection(self, connect_id, connect_cb=lambda: None, *, net, timeout_factor):
        ...
        logger.debug('Listening for Doriancoin Node with id: {}'.format(connect_id))
...
class P2PInterface(P2PConnection):
    """A high-level P2P interface class for communicating with a Doriancoin node.
