...
OpenSSL 3.0 moved RIPEMD160 into the legacy provider, so hashlib.new('ripemd160')
raises ValueError on distributions that ship it (Ubuntu 22.04 among them). The
functional tests need the digest regardless of what the local OpenSSL exposes.
"""
