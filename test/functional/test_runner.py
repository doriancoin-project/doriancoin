...
def run_tests(*, test_list, src_dir, build_dir, tmpdir, jobs=1, enable_coverage=False, args=None, combined_logs_len=0, failfast=False, use_term_control):
    ...
    try:
        ...
        if subprocess.run(["pgrep", "-x", "doriancoind"], stdout=subprocess.DEVNULL).returncode == 0:
...
def check_script_prefixes():
    ...
    good_prefixes_re = re.compile("(example|feature|interface|mempool|mining|p2p|rpc|wallet|tool|dsv|mweb)_")
