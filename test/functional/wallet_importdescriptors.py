...
class ImportDescriptorsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        addresses += ["rdsv1qrd3n235cj2czsfmsuvqqpr3lu6lg0ju7nw7yxh", "rdsv1qfqeppuvj0ww98r6qghmdkj70tv8qpche50fqxr"] # wpkh subscripts corresponding to the above addresses
        ...
        addresses = [
            'rdsv1qtmp74ayg7p24uslctssvjm06q5phz4yr92etag', # m/0'/0'/0
            'rdsv1q8vprchan07gzagd5e6v9wd7azyucksq29wlecr', # m/0'/0'/1
            'rdsv1qtuqdtha7zmqgcrr26n2rqxztv5y8rafjzn7l3c', # m/0'/0'/2
            'rdsv1qau64272ymawq26t90md6an0ps99qkrseh36emt', # m/0'/0'/3
            'rdsv1qsg97266hrh6cpmutqen8s4s962aryy773hw2xt', # m/0'/0'/4
        ]
        ...
        assert_equal(addr, 'rdsv1qdt0qy5p7dzhxzmegnn4ulzhard33s2809arjqgjndx87rv5vd0fqullk0g') # Derived at m/84'/0'/0'/0
        change_addr = wmulti_priv.getrawchangeaddress('bech32')
        assert_equal(change_addr, 'rdsv1qt9uhe3a9hnq7vajl7a094z4s3crm9ttf8zw3f5v9gr2nyd7e3lnsjjgjvk')
        ...
        assert_equal(addr, 'rdsv1qp8s25ckjl7gr6x2q3dx3tn2pytwp05upkjztk6ey857tt50r5aeq9axdg2') # Derived at m/84'/0'/0'/1
