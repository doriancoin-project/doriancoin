...
class WalletLabelsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        BECH32_VALID = {
            '✔️_VER15_PROG40': 'rdsv10qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq6auqml',
            '✔️_VER16_PROG03': 'rdsv1sqqqqqvsch97',
            '✔️_VER16_PROB02': 'rdsv1sqqqqamgqja',
        }
        BECH32_INVALID = {
